                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="POST" action="{{route('dashboard.products.update',$product->id)}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="{{$locale}}[name]"
                                                           value="{{ old($locale. '.name',$product->name)}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control ckeditor"
                                                        ...
                                                        {{ old($locale. '.description',$product->description)}}
                                                    </textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="purchace_price"
                                                       value="{{ old('purchace_price',$product->purchace_price)}}">
